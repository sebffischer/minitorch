...
class Module:
    ...
    def modules(self):
        ...
        # TODO why do it with self.__dict__ ?
...
def traverse(obj, dct, prefix):
    for key, value in obj._parameters.items():
        dct[prefix + key] = value

    for key, module in obj._modules.items():
        traverse(module, dct, prefix + key + ".")
